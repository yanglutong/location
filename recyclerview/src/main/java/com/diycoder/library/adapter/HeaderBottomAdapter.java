 ...
 */
public abstract class HeaderBottomAdapter<M, HVH extends RecyclerView.ViewHolder, IVH extends RecyclerView.ViewHolder, BVH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public boolean isFooter(int position) {
        return position == mHeaderCount + getContentItemCount() + mBottomCount;
    }
    ...
    private boolean isFullSpanType(int type) {
        return type == ITEM_TYPE_FOOTER || type == ITEM_TYPE_HEADER || type == ITEM_TYPE_BOTTOM;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_HEADER) {
            ...
            return onCreateBottomViewHolder(parent, viewType);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (isHeaderView(position)) {
            ...
            onBindBottomViewHolder(((BVH) holder), position);
    ...
    public int getItemCount() {
        return mHeaderCount + getContentItemCount() + mBottomCount + (hasFooter ? 1 : 0);
    }
    ...
    //bottom  ViewHolder 实现
    public abstract BVH onCreateBottomViewHolder(ViewGroup parent, int viewType);

    //bottom ViewHolder  data实现
    public abstract void onBindBottomViewHolder(final BVH holder, int position);
