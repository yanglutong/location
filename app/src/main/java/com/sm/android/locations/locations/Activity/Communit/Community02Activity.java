...
public class Community02Activity extends BaseActivity implements View.OnClickListener {
...
//        bt_add.setOnClickListener(this);
        ...
        UtilsView.setViewVisibility(this, layout, title, imageView, getResources().getString(R.string.coummunity_activity2), false, iv_findish, false);
    ...
    protected int getView() {
        return R.layout.activity_community02;
    }
