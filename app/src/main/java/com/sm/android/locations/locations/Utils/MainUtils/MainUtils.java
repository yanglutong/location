package com.sm.android.locations.locations.Utils.MainUtils;
...
import static com.sm.android.locations.locations.viewpagermain.ViewPagerMainActivity.FRAGMENTFLAG0;
import static com.sm.android.locations.locations.viewpagermain.ViewPagerMainActivity.FRAGMENTFLAG1;
import static com.sm.android.locations.locations.viewpagermain.ViewPagerMainActivity.FRAGMENTFLAG2;
//
...
//                        ToastUtils.showToast("连接wifi错误");
                    MyLog.e("ylt", "当前wifi名称： 2  "+wifiName);
...
//                        }
                    ...
                    String ID1TF = "";
                    String ID2TF = "";
                    System.out.println("收到之前zc" + dp.getAddress().getHostAddress() + "发送数据：" + str);
                    if (IP1.equals(dp.getAddress().getHostAddress())) {
                        mPressedTime1 = System.currentTimeMillis();
                        System.out.println("123456");
                        System.out.println("收到zc" + dp.getAddress().getHostAddress() + "发送数据：" + str);
...
//定位模式黑名单查询响应
                        if ("56f0".equals(str.substring(8, 12))) {
                            ...
                            Log.d(TAG, "run: 查询到的黑名单数量 "+blacklistNum);
                            int begin = 28;
                            int end = 58;
    ...
    public static void TYPES(final Handler handler) {//用于监听设备响应状态  黑名单清空状态,黑名单设置状态,设置定位模式状态  建立小区状态 ,
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while (true) {//是否开启
                    if (CALLBLACKFLAG1 == true) {//清空黑名单设备1
...
//                            System.out.println("执行了8121SSS");
                    ...
                    if (CALLBLACKFLAG2 == true) {//清空黑名单设备2
                        long blackTime11s = System.currentTimeMillis();
...
//                            System.out.println("执行了8121SSS");
                    ...
                    if (CALLBLACKFLAGSET1 == true) {//设置黑名单列表设备1
                        long blackTime11s = System.currentTimeMillis();
...
//                            System.out.println("执行了8131SSS");
                    ...
                    if (CALLBLACKFLAGSET2 == true) {//设置黑名单列表设备2
                        long blackTime11s = System.currentTimeMillis();
                    ...
                    if (CALLBLACKLOCATION1 == true) {//设置定位模式1
                        long blackTime11s = System.currentTimeMillis();
...
//                            System.out.println("执行了8151SSS");
                    ...
                    if (CALLBLACKLOCATION2 == true) {//设置定位模式2
                        long blackTime11s = System.currentTimeMillis();
