...
public class DBManagerZMDW {
    ...
    public DBManagerZMDW(Context context) throws SQLException {
        ...
        dao = ormHelper.getDao(Nzqzmbeandw.class);
    }
     ...
     * @thro
     */
    public int insertAddZmBean(Nzqzmbeandw zmBean) throws SQLException {
     ...
     * @throws SQLException
     */
    public void batchInsert(List<Nzqzmbeandw> zmBeans) throws SQLException {
        dao.create(zmBeans);
    }
     ...
     * @throws SQLException
     */
    public List<Nzqzmbeandw> getDataAll() throws SQLException {
        List<Nzqzmbeandw> list = dao.queryForAll();
        return list;
    }

    public Nzqzmbeandw forid(int id) throws SQLException {
        Nzqzmbeandw zmBean = (Nzqzmbeandw) dao.queryForId(id);
        return zmBean;
    }
     ...
     * @throws SQLException
     */
    public List<Nzqzmbeandw> queryGuanyu() throws SQLException {
        //Eq是equals的缩写
        //方法1
...
//        queryBuilder.where().eq("name", "关羽"); //多条件查询
        List<Nzqzmbeandw> query = queryBuilder.query();//此方法相当于build，提交设置
        return query;
    }
...
//    }
     ...
     * @throws SQLException
     */
    public int deleteAddPararBean(Nzqzmbeandw zmBean) throws SQLException {
        //只看id
...
//        dao.execSQL("delete from tab_name");
     ...
     * @throws SQLException
     */
    public int updateCheck(Nzqzmbeandw zmBean) throws SQLException {
//        guijiViewBean.setUp(91);
    ...
    public int updateCheck2(Nzqzmbeandw zmBean) throws SQLException {
//        guijiViewBean.setUp(91);
