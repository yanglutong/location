 ...
 * 封装各种操作数据库的方法
 */
public class DBManagerZmDATAPdList {
    ...
    public DBManagerZmDATAPdList(Context context) throws SQLException {
        ...
        dao = ormHelper.getDao(ZmBeanPdDATAlbenan.class);
    }
     ...
     * @thro
     */
    public int insertAddZmBeanlinshi(ZmBeanPdDATAlbenan ZmBeanlinshi) throws SQLException {
     ...
     * @throws SQLException
     */
    public void batchInsert(List<ZmBeanPdDATAlbenan> ZmBeanlinshis) throws SQLException {
     ...
     * @throws SQLException
     */
    public List<ZmBeanPdDATAlbenan> getDataAll() throws SQLException {
        List<ZmBeanPdDATAlbenan> list = dao.queryForAll();
        return list;
    }

    public ZmBeanPdDATAlbenan forid(int id) throws SQLException {
        ZmBeanPdDATAlbenan ZmBeanlinshi = (ZmBeanPdDATAlbenan) dao.queryForId(id);
        return ZmBeanlinshi;
    }
     ...
     * @throws SQLException
     */
    public List<ZmBeanPdDATAlbenan> queryGuanyu() throws SQLException {
        //Eq是equals的缩写
        //方法1
...
//        queryBuilder.where().eq("name", "关羽"); //多条件查询
     ...
     * @throws SQLException
     */
    public List<ZmBeanPdDATAlbenan> queryTime(String Mytime) throws SQLException {
        //Eq是equals的缩写
        //方法1
        List<ZmBeanPdDATAlbenan> list = dao.queryForEq("time", Mytime);
//
//        //方法2
//        QueryBuilder queryBuilder = dao.queryBuilder();
////        queryBuilder.offset(); //偏移量
...
//    }
     ...
     * @throws SQLException
     */
    public int deleteAddPararBean(ZmBeanPdDATAlbenan ZmBeanlinshi) throws SQLException {
        //只看id
...
//        dao.execSQL("delete from tab_name");
     ...
     * @throws SQLException
     */
    public int updateCheck(ZmBeanPdDATAlbenan ZmBeanlinshi) throws SQLException {
//        guijiViewBean.setUp(91);
     ...
     * @throws SQLException
     */
    public int updateStopTtime(ZmBeanPdDATAlbenan ZmBeanlinshi) throws SQLException {
//        guijiViewBean.setUp(91);
    ...
    public int updateCheck2(ZmBeanPdDATAlbenan ZmBeanlinshi) throws SQLException {
//        guijiViewBean.setUp(91);
