...
public class ZhenmaBsShowAdapter extends RecyclerView.Adapter<ZhenmaBsShowAdapter.ViewHolder> {
    private TextView tv_imsi2;
    private TextView tv_imsi1;
    private ZhenmaCallBack zhenmaCallBack;
    private List<Integer> list1size;
    private List<ZmBeanBsDATAlbenan> dataAll;
    private Context basecontext;

    private  List<ZmBeanBsDATAlbenan> list;
    private Context context;
    List<Integer> listsize;

    public ZhenmaBsShowAdapter(Context basecontext, List<ZmBeanBsDATAlbenan>list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        ZhenmaBsShowAdapter.ViewHolder viewHolder = new ZhenmaBsShowAdapter.ViewHolder(view);
        return viewHolder;
    }
