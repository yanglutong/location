...
import com.sm.android.locations.location.sos.MubiaopSOS;
...
public class RyZmAdapterGkMUBIAO extends RecyclerView.Adapter<RyZmAdapterGkMUBIAO.ViewHolder> {
    ...
    int add;
    MubiaopSOS.XuanzeCallback xuanzecallback;
    @SuppressLint("NewApi")
    public RyZmAdapterGkMUBIAO(Context basecontext, List<ZmBeanGKTongji> list, List<Integer> listsize, MubiaopSOS.XuanzeCallback xuanzecallback) {
        this.list = list;
        this.basecontext = basecontext;
        this.listsize = listsize;
        this.xuanzecallback=xuanzecallback;
...
//        Log.d("nsaqsjbj", "RyZmAdapterGk: " + l.toString());
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.sos_mubiaobiaoxuanze_item, viewGroup, false);
        RyZmAdapterGkMUBIAO.ViewHolder viewHolder = new RyZmAdapterGkMUBIAO.ViewHolder(view);
        return viewHolder;
    }
...
//                holder.tv_sb.setTextColor(basecontext.getColor(R.color.gray_black));
        ...
        holder.cb_xuanze.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    list.get(position).setCheck(true);
                    xuanzecallback.Call(list);
                }else {
