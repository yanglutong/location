...
import com.sm.android.locations.locations.zhenma.LinshiBenjieguo;
import com.sm.android.locations.locations.zhenma.ZhenmaPZShowActivity;

import java.util.ArrayList;
import java.util.List;

public class ZhenmaFenxPziAdapter extends RecyclerView.Adapter<ZhenmaFenxPziAdapter.ViewHolder> {
    public static List<LinshiBenjieguo> ZMBEANLINSHILIST = new ArrayList<>();
    private List<ZmBeanPdlbenan> listJieguoS;
    private String time;
    private ZhenmaPdCallBack zhenmaCallBack;
    private List<Integer> list1size;
    private List<AddPararBean> dataAll;


    private List<List<ZmBeanlinshi>> list;
    private Context basecontext;
    List<Integer> listsize;
    List<Integer> list1;

    public ZhenmaFenxPziAdapter(Context basecontext, List<List<ZmBeanlinshi>> list, List<Integer> listsize, ZhenmaPdCallBack zhenmaCallBack, String time, List<Integer> list1, List<ZmBeanPdlbenan> listJieguoS) {
    ...
    public ZhenmaFenxPziAdapter(Context basecontext, List<ZmBeanPdlbenan> listJieguoS, ZhenmaPdCallBack zhenmaCallBack) {
        this.basecontext = basecontext;
        this.zhenmaCallBack = zhenmaCallBack;
        this.listJieguoS = listJieguoS;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        ZhenmaFenxPziAdapter.ViewHolder viewHolder = new ZhenmaFenxPziAdapter.ViewHolder(view);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.tv_stoptime.setText("碰撞分析");//碰撞类型
        holder.tv_imsishow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                List<ZmBeanPdlbenan> linshiBenjieguoList = new ArrayList<>();
//                for (int i = 0; i < listJieguoS.size(); i++) {
//                    String num = listJieguoS.get(i).g();
//                    if (Integer.parseInt(num) > 1) {
//                        linshiBenjieguoList.add(listJieguoS.get(i));
//                    }
//                }
//                if (listJieguoS.size() > 0) {
//                    ToastUtils.showToast("有碰撞关系数据大于一条");
                    Intent intent = new Intent(basecontext, ZhenmaPZShowActivity.class);
...
//            }
    ...
    public interface ZhenmaPdCallBack {
