...
public class LunxunAdapterFragment extends RecyclerView.Adapter<LunxunAdapterFragment.ViewHolder> {
    private  String name;
    ...
    int add;
    LunxunAdapterFragment.IDialogSaopin dialogSaopin;

    public LunxunAdapterFragment(LunxunSetingActivity lunxunSetingActivity) {
        this.context = lunxunSetingActivity;
    }

    public LunxunAdapterFragment(Context saoPinSetingActivity, List<SaopinBean> spBeanList, LunxunAdapterFragment.IDialogSaopin dialogSaopin, String name) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        LunxunAdapterFragment.ViewHolder viewHolder = new LunxunAdapterFragment.ViewHolder(view);
        return viewHolder;
    }
