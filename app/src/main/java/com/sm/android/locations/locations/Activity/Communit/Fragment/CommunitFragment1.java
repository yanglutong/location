package com.sm.android.locations.locations.Activity.Communit.Fragment;
...
//        image_jiahao =  view.findViewById(R.id.image_jiahao);
//        image_jiahao.setOnClickListener(this);
//        bt_cancel =  view.findViewById(R.id.bt_cancel);
//        bt_cancel.setOnClickListener(this);
//        LinearLayout layout =  view.findViewById(R.id.ll_tab);
//        TextView title =  view.findViewById(R.id.titles);
//        ImageView imageView =  view.findViewById(R.id.iv_menu);
//        ImageView iv_findish = view. findViewById(R.id.iv_finish);
//        iv_findish.setOnClickListener(this);
//        UtilsView.setViewVisibility(mContext, layout, title, imageView, getResources().getString(R.string.coummunity_activity2), false, iv_findish, false);


//        mFinsh = (ImageView)view. findViewById(R.id.finsh);
//        mMytitle = (TextView)view. findViewById(R.id.mytitle);
//        mImage_jiahao = (ImageView) view.findViewById(R.id.image_jiahao);


//        et_tddd,et_tddz,et_tddg,et_fddd,et_fddz,et_fddg;
        et_tddd = view.findViewById(R.id.et_tddd);
        et_tddz = view.findViewById(R.id.et_tddz);
        et_tddg = view.findViewById(R.id.et_tddg);
        et_fddd = view.findViewById(R.id.et_fddd);
        et_fddz = view.findViewById(R.id.et_fddz);
        et_fddg = view.findViewById(R.id.et_fddg);
...
//        bindViews();
        ...
        try {
            ...
            if (forid == null) {
                ...
                TDDFDDzyBean forid1 = zy.forid(1);
//                et_tddd,et_tddz,et_tddg,et_fddd,et_fddz,et_fddg;
                ...
                Log.d("TDDFDDzyBean", "getData: " + forid1);
...
//                finish();
                ...
                if (spItem == 0) {//空口同步
                    MainUtils.SetType(IP1, 0);

                } else {//GPS同步
                    MainUtils.SetType(IP1, 1);
                }
...
//
    ...
    private boolean isNulls() {
        ...
        if (!TextUtils.isEmpty(et_gl.getText().toString())) {
            String ad = et_gl.getText().toString();
            Double i = Double.parseDouble(et_gl.getText().toString());
            if (0 <= i && i <= 2) {

            } else {
                ToastUtils.showToast("射频功率应为0-65535之间");
                return true;
            }
        } else {
            ToastUtils.showToast("射频功率不能为空");
            return true;
        }
