...
public class LunxunAdapterFragment0 extends RecyclerView.Adapter<LunxunAdapterFragment0.ViewHolder> {
    private String name;
    ...
    int add;
    LunxunAdapterFragment0.IDialogSaopin0 dialogSaopin;
    List<Integer> numlist;

    public LunxunAdapterFragment0(LunxunSetingActivity lunxunSetingActivity) {
        this.context = lunxunSetingActivity;
    }


    public LunxunAdapterFragment0(Context saoPinSetingActivity, List<LunxunBean> spBeanList, LunxunAdapterFragment0.IDialogSaopin0 dialogSaopin, String name, List<Integer> numlist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        LunxunAdapterFragment0.ViewHolder viewHolder = new LunxunAdapterFragment0.ViewHolder(view);
        return viewHolder;
    }
...
//                    dialogPinConfig.update();
    ...
    // 内部接口
    public interface IDialogSaopin0 {
