...
public class RyZmAdapterdw extends RecyclerView.Adapter<RyZmAdapterdw.ViewHolder> {
    ...
    public RyZmAdapterdw(Context basecontext, List<ZmBean> list, List<Integer>listsize) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        RyZmAdapterdw.ViewHolder viewHolder = new RyZmAdapterdw.ViewHolder(view);
        return viewHolder;
    }
