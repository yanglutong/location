...
public class SaopinAdapterFragment3 extends RecyclerView.Adapter<SaopinAdapterFragment3.ViewHolder> {
    ...
    int add;
    SaopinAdapterFragment3.IDialogSaopin3 dialogSaopin;
    List<Integer> numlist;
    public SaopinAdapterFragment3(SaoPinSetingActivity saoPinSetingActivity) {
        this.context = saoPinSetingActivity;
    }

    public SaopinAdapterFragment3(Context saoPinSetingActivity, List<SaopinBean> spBeanList, SaopinAdapterFragment3.IDialogSaopin3 dialogSaopin, String name, List<Integer> numlist) {
        this.context = saoPinSetingActivity;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        SaopinAdapterFragment3.ViewHolder viewHolder = new SaopinAdapterFragment3.ViewHolder(view);
        return viewHolder;
    }
