 ...
 * 封装各种操作数据库的方法
 */
public class DBManagerZmPdList {
    ...
    public DBManagerZmPdList(Context context) throws SQLException {
        ...
        dao = ormHelper.getDao(ZmBeanPdlbenan.class);
    }
     ...
     * @thro
     */
    public int insertAddZmBeanlinshi(ZmBeanPdlbenan ZmBeanlinshi) throws SQLException {
     ...
     * @throws SQLException
     */
    public void batchInsert(List<ZmBeanPdlbenan> ZmBeanlinshis) throws SQLException {
     ...
     * @throws SQLException
     */
    public List<ZmBeanPdlbenan> getDataAll() throws SQLException {
        List<ZmBeanPdlbenan> list = dao.queryForAll();
        return list;
    }

    public ZmBeanPdlbenan forid(int id) throws SQLException {
        ZmBeanPdlbenan ZmBeanlinshi = (ZmBeanPdlbenan) dao.queryForId(id);
        return ZmBeanlinshi;
    }
     ...
     * @throws SQLException
     */
    public List<ZmBeanPdlbenan> queryGuanyu() throws SQLException {
        //Eq是equals的缩写
        //方法1
...
//        queryBuilder.where().eq("name", "关羽"); //多条件查询
        List<ZmBeanPdlbenan> query = queryBuilder.query();//此方法相当于build，提交设置
        return query;
    }
...
//    }
     ...
     * @throws SQLException
     */
    public int deleteAddPararBean(ZmBeanPdlbenan ZmBeanlinshi) throws SQLException {
        //只看id
...
//        dao.execSQL("delete from tab_name");
     ...
     * @throws SQLException
     */
    public int updateCheck(ZmBeanPdlbenan ZmBeanlinshi) throws SQLException {
//        guijiViewBean.setUp(91);
     ...
     * @throws SQLException
     */
    public int updateStopTtime(ZmBeanPdlbenan ZmBeanlinshi) throws SQLException {
//        guijiViewBean.setUp(91);

        int update = dao.update(ZmBeanlinshi);
        return update;
    }
    public int updateCheck2(ZmBeanPdlbenan ZmBeanlinshi) throws SQLException {
//        guijiViewBean.setUp(91);
