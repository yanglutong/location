...
public class DBManagerZX {
     ...
     * @throws SQLException
     */
    public DBManagerZX(Context context) throws SQLException {
        ...
        dao = ormHelper.getDao(ZcBean.class);
    }
     ...
     * @thro
     */
    public void insertConmmunit01Bean(ZcBean zcBean) throws SQLException {
     ...
     * @throws SQLException
     */
    public void batchInsert(List<ZcBean> zcBeans) throws SQLException {
        dao.create(zcBeans);
    }
     ...
     * @throws SQLException
     */
    public ZcBean forid(int i) throws SQLException {
        ZcBean zcBean = (ZcBean) dao.queryForId(i);
        return zcBean;
    }
     ...
     * @throws SQLException
     */
    public List<ZcBean> getZcBean1Beans() throws SQLException {
        List<ZcBean> list = dao.queryForAll();
        return list;
    }
     ...
     * @throws SQLException
     */
    public List<ZcBean> queryGuanyu() throws SQLException {
        //Eq是equals的缩写
        //方法1
...
//        queryBuilder.orderBy("age",true);
        ...
        List<ZcBean> query = queryBuilder.query();//此方法相当于build，提交设置
        return query;
    }
...
//    }
     ...
     * @throws SQLException
     */
    public void deleteConmmunit01Bean(ZcBean zcBean) throws SQLException {
        //只看id
        dao.delete(zcBean);
    }
     ...
     * @throws SQLException
     */
    public void updateConmmunit01Bean(ZcBean zcBean) throws SQLException {
