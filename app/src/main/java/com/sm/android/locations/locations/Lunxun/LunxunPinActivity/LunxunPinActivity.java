package com.sm.android.locations.locations.Lunxun.LunxunPinActivity;
...
public class LunxunPinActivity extends BaseActivity implements View.OnClickListener {
    Button bt_add;
...
//        iv_add.setOnClickListener(this);
        ...
        ry.setLayoutManager(new LinearLayoutManager(LunxunPinActivity.this, LinearLayoutManager.VERTICAL, false));
...
//            }
            SaopinListAdapter saopinListAdapter = new SaopinListAdapter(LunxunPinActivity.this, SPBEANLIST1);
            ry.setAdapter(saopinListAdapter);
        }
        if (type.equals("2")) {
            UtilsView.setViewVisibility(this, layout, title, imageView, "设备2小区信息", false, iv_finish, true);

            SaopinListAdapter saopinListAdapter = new SaopinListAdapter(LunxunPinActivity.this, SPBEANLIST2);
            ry.setAdapter(saopinListAdapter);
        }
    }
