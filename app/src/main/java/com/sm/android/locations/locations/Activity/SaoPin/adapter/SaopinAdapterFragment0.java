...
public class SaopinAdapterFragment0 extends RecyclerView.Adapter<SaopinAdapterFragment0.ViewHolder> {
    private String name;
    ...
    int add;
    SaopinAdapterFragment0.IDialogSaopin0 dialogSaopin;
    List<Integer> numlist;

    public SaopinAdapterFragment0(SaoPinSetingActivity saoPinSetingActivity) {
        this.context = saoPinSetingActivity;
    }


    public SaopinAdapterFragment0(Context saoPinSetingActivity, List<SaopinBean> spBeanList, SaopinAdapterFragment0.IDialogSaopin0 dialogSaopin, String name, List<Integer> numlist) {
        this.context = saoPinSetingActivity;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        SaopinAdapterFragment0.ViewHolder viewHolder = new SaopinAdapterFragment0.ViewHolder(view);
        return viewHolder;
    }
