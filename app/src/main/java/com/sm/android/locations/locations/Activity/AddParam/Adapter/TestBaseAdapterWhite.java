...
import com.sm.android.locations.locations.Activity.AddParam.UpdataParamActivity;
import com.sm.android.locations.locations.Activity.AddParam.UpdataParamWhiteActivity;
 ...
 */
public class TestBaseAdapterWhite extends BaseAdapter<TestData, TestBaseAdapterWhite.ItemViewHolder> {

    private WhiteITTestBaseAdapterCallBack callBack;
    private Context mContext;
    private final LayoutInflater mLayoutInflater;

    public TestBaseAdapterWhite(Context context) {
        super(context);
        this.mContext = context;
        mLayoutInflater = LayoutInflater.from(context);
    }

    public TestBaseAdapterWhite(Context context, WhiteITTestBaseAdapterCallBack callBack) {
        super(context);
        this.mContext = context;
        mLayoutInflater = LayoutInflater.from(context);
...
//                          将属性设置给窗体
            ...
            holder.ll_bianji.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(mContext, UpdataParamWhiteActivity.class);
...
////                    recyclerView.setAdapter(mAdapter);
    ...
    public interface WhiteITTestBaseAdapterCallBack {
