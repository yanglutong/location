...
public class SaopinAdapterFragment1 extends RecyclerView.Adapter<SaopinAdapterFragment1.ViewHolder> {
    private  String name;
    ...
    SaopinAdapterFragment1.IDialogSaopin1 dialogSaopin;

    public SaopinAdapterFragment1(SaoPinSetingActivity saoPinSetingActivity) {
        this.context = saoPinSetingActivity;
    }

    public SaopinAdapterFragment1(Context saoPinSetingActivity, List<SaopinBean> spBeanList, SaopinAdapterFragment1.IDialogSaopin1 dialogSaopin, String name, List<Integer> numlist) {
        this.context = saoPinSetingActivity;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        SaopinAdapterFragment1.ViewHolder viewHolder = new SaopinAdapterFragment1.ViewHolder(view);
        return viewHolder;
    }
