package com.sm.android.locations.locations.Constant;
...
public class Constant {
    ...
    //打开公放// 打开风扇
    public static String OPENGF = "aa aa 55 55 9f f0 10 00 00 00 00 ff 01 00 00 00";
    //关闭公放  //关闭风扇
    public static String CLOSEGF = "aa aa 55 55 9f f0 10 00 00 00 00 ff 00 00 00 00";
    //小区去激活(停止定位)
