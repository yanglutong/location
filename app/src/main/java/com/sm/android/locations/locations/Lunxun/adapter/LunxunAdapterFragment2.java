...
public class LunxunAdapterFragment2 extends RecyclerView.Adapter<LunxunAdapterFragment2.ViewHolder> {
    private  String name;
    ...
    int add;
    LunxunAdapterFragment2.IDialogSaopin2 dialogSaopin;
    List<Integer> numlist;
    public LunxunAdapterFragment2(LunxunSetingActivity lunxunSetingActivity) {
        this.context = lunxunSetingActivity;
    }

    public LunxunAdapterFragment2(Context saoPinSetingActivity, List<LunxunBean> spBeanList, LunxunAdapterFragment2.IDialogSaopin2 dialogSaopin, String name, List<Integer> numlist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        LunxunAdapterFragment2.ViewHolder viewHolder = new LunxunAdapterFragment2.ViewHolder(view);
        return viewHolder;
    }
...
//                    dialogPinConfig.update();
    ...
    // 内部接口
    public interface IDialogSaopin2 {
