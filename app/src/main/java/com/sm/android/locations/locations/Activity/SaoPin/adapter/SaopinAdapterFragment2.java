package com.sm.android.locations.locations.Activity.SaoPin.adapter;
...
public class SaopinAdapterFragment2 extends RecyclerView.Adapter<SaopinAdapterFragment2.ViewHolder> {
    private  String name;
    ...
    int add;
    SaopinAdapterFragment2.IDialogSaopin2 dialogSaopin;
    List<Integer> numlist;
    public SaopinAdapterFragment2(SaoPinSetingActivity saoPinSetingActivity) {
        this.context = saoPinSetingActivity;
    }

    public SaopinAdapterFragment2(Context saoPinSetingActivity, List<SaopinBean> spBeanList, SaopinAdapterFragment2.IDialogSaopin2 dialogSaopin, String name, List<Integer> numlist) {
        this.context = saoPinSetingActivity;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        SaopinAdapterFragment2.ViewHolder viewHolder = new SaopinAdapterFragment2.ViewHolder(view);
        return viewHolder;
    }
