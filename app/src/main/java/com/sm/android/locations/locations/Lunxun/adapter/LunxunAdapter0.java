...
public class LunxunAdapter0 extends RecyclerView.Adapter<LunxunAdapter0.ViewHolder> {
    private IDialogSaopin dialogPinConfig;
    private List<SaopinBean> spBeanList;
    private Context context;
    DBManagersaopin dbManager = null;
    int add;
    public LunxunAdapter0(LunxunSetingActivity lunxunSetingActivity){
        this.context = lunxunSetingActivity;
    }
    public LunxunAdapter0(LunxunSetingActivity lunxunSetingActivity, List<SaopinBean> spBeanList, IDialogSaopin dialogPinConfig) {
        this.context = lunxunSetingActivity;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        LunxunAdapter0.ViewHolder viewHolder = new LunxunAdapter0.ViewHolder(view);
        return viewHolder;
    }
