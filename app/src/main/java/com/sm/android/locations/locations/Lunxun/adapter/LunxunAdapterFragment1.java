package com.sm.android.locations.locations.Lunxun.adapter;
...
public class LunxunAdapterFragment1 extends RecyclerView.Adapter<LunxunAdapterFragment1.ViewHolder> {
    private  String name;
    ...
    LunxunAdapterFragment1.IDialogSaopin1 dialogSaopin;

    public LunxunAdapterFragment1(LunxunSetingActivity lunxunSetingActivity) {
        this.context = lunxunSetingActivity;
    }

    public LunxunAdapterFragment1(Context saoPinSetingActivity, List<LunxunBean> spBeanList, LunxunAdapterFragment1.IDialogSaopin1 dialogSaopin, String name, List<Integer> numlist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        LunxunAdapterFragment1.ViewHolder viewHolder = new LunxunAdapterFragment1.ViewHolder(view);
        return viewHolder;
    }
...
//                    dialogPinConfig.update();
    ...
    // 内部接口
    public interface IDialogSaopin1 {
        ...
        public void upbianji(LunxunBean saopinBean);//编辑的回调
    }
}
