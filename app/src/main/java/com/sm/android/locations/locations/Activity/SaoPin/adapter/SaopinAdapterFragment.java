...
public class SaopinAdapterFragment extends RecyclerView.Adapter<SaopinAdapterFragment.ViewHolder> {
    private  String name;
    ...
    int add;
    SaopinAdapterFragment.IDialogSaopin dialogSaopin;

    public SaopinAdapterFragment(SaoPinSetingActivity saoPinSetingActivity) {
        this.context = saoPinSetingActivity;
    }

    public SaopinAdapterFragment(Context saoPinSetingActivity, List<SaopinBean> spBeanList, SaopinAdapterFragment.IDialogSaopin dialogSaopin,String name) {
        this.context = saoPinSetingActivity;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        SaopinAdapterFragment.ViewHolder viewHolder = new SaopinAdapterFragment.ViewHolder(view);
        return viewHolder;
    }
...
//        add++;
        ...
        holder.tv_xulie.setText(spBeanList.size()+1 + "");
